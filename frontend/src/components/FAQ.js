...
const faqs = [
  {
    ...
    answer:
      "Samprabhav is a great event to get yourself connected with industry experts and increase your networking potential. Furthermore, you’ll get an in-depth knowledge about the recent on-goings of the Pharma industry.",
    icon: <UserCheck size={20} className="faq-icon" />,
  },
  {
    question: "Will I get any certificate for attending the event?",
    answer:
      "Yes, the registered attendees will be awarded with the certificates.",
    icon: <Award size={20} className="faq-icon" />,
  },
  {
    question: "What are the educational eligibility criteria for the event?",
    answer:
      "Students pursuing M.B.A. (Core / Pharm. Management) or B. Pharm. or Pharm.D are eligible for the event.",
    icon: <GraduationCap size={20} className="faq-icon" />,
  },
  {
    question: "Are on-spot registrations available?",
    answer:
      "Yes, it is available. But try to register early to avoid last minute validations.",
